...
function Contact_form() {
  return (
    <form className="mt-7">
      <div className="grid grid-cols-1  gap-7 lg:grid-cols-2 mobile-landscape:grid-cols-2 md:grid-cols-2 border p-5 lg:py-10  rounded-md border-[#ffffff25]">
        <input
          type="text"
          placeholder="Your Name"
          className="placeholder:text-white font-[15px] py-4 text-white  border-1 border-[#ffffff40] rounded-circle px-5 focus:outline-none outline-none"
        />
        <input
          type="email"
