  ...
  return (
    <footer className="pt-60 md:pt-32">
      <div className="bg-[#22002d] text-white relative bottom-0 left-0 flex items-center flex-col">
        {/* Contact Bar */}
        <div className="mx-auto absolute -top-32 mobile-landscape:-top-24 lg:-top-16 md:-top-24 w-[90%] mobile-landscape:w-full max-w-[1200px] 2xl:max-w-[1500px]">
        ...
        {/* Main Footer */}
        <div className="mt-32 mobile-landscape:mt-24 md:mt-24 lg:mt-16 mx-auto px-4 py-14  max-w-[1200px] 2xl:max-w-[1500px]">
