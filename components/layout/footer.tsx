...
function Footer() {
  return (
    <footer className="bg-[#22002d] text-white relative flex items-center flex-col hidden">
      {/* Contact Bar */}
        ...
        <div className=" bg-primary flex px-4 py-8 rounded-2xl flex-col gap-8 mobile-landscape:grid mobile-landscape:grid-cols-2 md:grid  md:grid-cols-2 lg-grid-cols-3 lg:rounded-b-2xl lg:flex lg:flex-row lg:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-semibold">4648 Dallas Road TX, 19206</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-semibold">info@saveavillage.org</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-semibold">+1 (214) 642 7635</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <ul className="space-y-4 mt-7">
              {footerLinks.map((item: IFooterLinks, key: number) => {
                return (
                  ...
                  >
                    <span>
                      <FaAnglesRight size={12} className="text-white! mt-0.5" />
                    </span>
